...
export const twColors = {
  ...
  textModified: 'text-[var(--vscode-diffEditor-modifiedTextForeground,#f59e0b)]',
  ...
  bgAdded: 'bg-[var(--vscode-diffEditor-insertedTextBackground,rgba(34,197,94,0.2))]',
  bgRemoved: 'bg-[var(--vscode-diffEditor-removedTextBackground,rgba(239,68,68,0.2))]',
  bgModified: 'bg-[var(--vscode-diffEditor-modifiedTextBackground,rgba(245,158,11,0.2))]',
  ...
  borderError: 'border-[var(--vscode-diffEditor-removedTextForeground,#ef4444)]',
  borderWarning: 'border-[var(--vscode-diffEditor-modifiedTextForeground,#f59e0b)]',
  borderAdded: 'border-[var(--vscode-diffEditor-insertedTextForeground,#22c55e)]',
  borderRemoved: 'border-[var(--vscode-diffEditor-removedTextForeground,#ef4444)]',
  borderModified: 'border-[var(--vscode-diffEditor-modifiedTextForeground,#f59e0b)]',
}
